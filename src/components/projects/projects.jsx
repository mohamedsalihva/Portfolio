...
const Projects = () => {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-gray-800 to-gray-900 text-white" id="projects">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Work</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {projectsData.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-blue-400 text-center">{project.title}</h3>
